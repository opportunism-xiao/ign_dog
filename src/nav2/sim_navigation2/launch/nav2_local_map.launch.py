...
def generate_launch_description():
    ...
    map_server_yaml = os.path.join(get_package_share_directory('local_map'), 'params', 'map_server.yaml')
    ...
    ld.add_action(DeclareLaunchArgument('scan_topic', default_value='/scan/filtered'))
    ...
    map_server_node = Node(
        ...
        name='map_server',
        parameters=[
            LaunchConfiguration('map_server_yaml'),
